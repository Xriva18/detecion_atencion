    ...
    <div className="flex min-h-screen items-center justify-center bg-zinc-50 font-sans dark:bg-black">
      <main className="flex min-h-screen w-full max-w-7xl flex-col items-center justify-center py-4 px-4 sm:py-8 sm:px-6 lg:px-8 bg-white dark:bg-black">
        <div className="flex flex-col items-center justify-center gap-4 sm:gap-6 lg:gap-8 w-full flex-1">
          ...
          {!isLoading && !error && (
            <div className="w-full flex flex-col md:flex-row gap-4 sm:gap-6 items-center justify-center md:justify-center">
              ...
              {/* Columna derecha: Mensaje del servidor y detalles */}
              <div className="flex flex-col gap-3 sm:gap-4 w-full md:w-auto md:flex-1 md:max-w-md lg:max-w-lg items-center md:items-center justify-center">
